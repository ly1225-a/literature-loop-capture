        ...
        "subquestions": [
            {
                ...
                "subquestion_group_slug": "agent-chosen-group",
                "subquestion_group_title": "Agent Chosen Group",
                "subquestion_text": "Agent-authored atomic subquestion grounded in OpenAlex evidence and the user review goal.",
                "query_family": "agent-chosen-focus",
                "queries": [
                    {
...
def render_agent_packet(claim: str, rounds: int, openalex_audit: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        "- Decide the subquestion axes from the OpenAlex metadata and the user's review goal; do not force a fixed resources/methods/evaluation/applications/limitations template.",
